...
class WomanProducts extends StatefulWidget {
  const WomanProducts({super.key});

  @override
  State<WomanProducts> createState() => _WomanProductsState();
}

class _WomanProductsState extends State<WomanProducts> {
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    ...
    final model = providerModel.getWomanProductsData;
