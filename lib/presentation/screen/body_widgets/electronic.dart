...
class ElectronicProducts extends StatefulWidget {
  const ElectronicProducts({super.key});

  @override
  State<ElectronicProducts> createState() => _ElectronicProductsState();
}

class _ElectronicProductsState extends State<ElectronicProducts> {
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    ...
    final model = providerModel.getElectronicProductsData;
