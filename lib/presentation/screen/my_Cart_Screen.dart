  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Provider.of<MyCart>(context).getMyCartData.isNotEmpty
                              ...
                              child: Slidable(
                                ...
                                child: ListTile(
                                  ...
                                  leading: Image.network(
                                    snap.getMyCartData[index].products.image
                                        .toString(),
                                    height: 70,
                                    fit: BoxFit.fitHeight,
                                  ),
                                  title: Text(
                                    snap.getMyCartData[index].products.title
                                        .toString(),
                                    maxLines: 2,
                                  ),
                                  subtitle: Text(
                                      "Price : ${snap.getMyCartData[index].products.price} \$"),
                                  trailing: SizedBox(
                                    width: 150,
                                    child: Row(
                                      mainAxisAlignment:
                                      ...
                                      children: [
                                        ...
                                        Text(snap.getMyCartData[index].totalItem
                                            .toString()),
                                        ElevatedButton(
                                            onPressed: () {
                                              Provider.of<MyCart>(context,
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            "${Provider.of<MyCart>(context).getTotalProductPrice.toStringAsFixed(2)}\$",
                            style: cartPricingStyle,
                          ),
                        ],
                      ),
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            "${Provider.of<MyCart>(context).getTotalVat.toStringAsFixed(2)}\$",
                            style: cartPricingStyle,
                          ),
                        ],
                      ),
          ...
          : const Center(
              child: Text("You Have Not Added Any Item Yet : ("),
            ),
