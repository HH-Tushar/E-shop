...
import 'package:e_shop/ui/screen/sineup_screen.dart';
      ...
      body:Center(
        child: Column(
          ...
          children: [
            ...
            Lottie.asset('assets/animation/intro.json',height: 280 - progress * 128),
                      ...
                      InkWell(
                        ...
                        child: Stack(
                          ...
                          children: [
                            ...
                            Opacity(
                                opacity: progress,
                                child: const CustomButton(buttonName: "Sine up")),
                          ],
                        ),
                      ),
                      SizedBox(height: 5),
